...
namespace Door\RDB\Database\Query\Builder;
use Door\RDB\Database\Query\Builder;
...
class Insert extends Builder {
	 ...
	 * @return  void
	 */
	public function __construct(Database $db, $table = NULL, array $columns = NULL)
	{
		if ($table)
		{
		...
		return parent::__construct($db, Database::INSERT, '');
	}
	...
	public function values(array $values)
	{
		...
		$all_values = func_get_args();

		$this->_values = array_merge($this->_values, $all_values);
