...
namespace Door\RDB\Database\Query;
use Door\RDB\Database\Query;
use Door\RDB\Database;
use Door\RDB\Database\Dependent;
...
abstract class Builder extends Query {
	 ...
	 *
	 * @param   object  $this->db()     Database instance
	...
	protected function _compile_join(array $joins)
	{
		...
		foreach ($joins as $join)
		{
			...
			$statements[] = $join->compile($this->db());
		}
	 ...
	 * @return  string
	 */
	protected function _compile_group_by(array $columns)
	{
		$group = array();
