...
class Query extends Dependent {
	 ...
	 * @return  void
	 */
	public function __construct(Database $db, $type, $sql)
	{
		$this->_type = $type;
		$this->_sql = $sql;
	...
	public function compile()
	{
		...
		if ( ! empty($this->_parameters))
		{
			...
			$values = array_map(array($this->db(), 'quote'), $this->_parameters);
	 ...
	 */
	public function execute($as_object = NULL, $object_params = NULL)
	{
		if ($as_object === NULL)
		{
		...
		// Execute the query
		$result = $this->db()->perform($this->_type, $sql, $as_object, $object_params);
